...
Component({
  ...
  properties: {
    ...
    showName: {
      ...
      value: true,
      observer: function(newVal, oldVal, changedPath) {
        this.changeShowName(newVal);
      }
    },

    result: {
      type: String || Number, // 奖项的下标值，默认0
      value: 0,
      observer: function(newVal, oldVal, changedPath) {
        this.changeResult(newVal);
      }
    },
   ...
   */
  data: {
    pointR: '../../images/point-r.png',
    pointR2: '../../images/point-r2.png',
    pointW: '../../images/point-w.png',
    pointY: '../../images/point-y.png',
    circleR: 'https://image.topeffects.cn/wxgame/circle-r.png',
    // pointR: 'https://image.topeffects.cn/wxgame/point-r.png',
    // pointY: 'https://image.topeffects.cn/wxgame/point-y.png',
    pointImage: 'https://image.topeffects.cn/wxgame/point.png',
    animationData: {}, // 转盘动画
  ...
  methods: {
    ...
    _zhuan() {
      ...
      setTimeout(function() {
        //要转多少度deg
        runDegs = runDegs || 0, runDegs = runDegs + (360 - runDegs % 360) + (4320 - r * (360 / awardsConfig.awards.length));
